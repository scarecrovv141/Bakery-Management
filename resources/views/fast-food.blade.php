				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item active"><a class="nav-link" href="/fast-food">Fast Food</a></li>
                  ...
                  <div class="table-responsive">
                    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                          ...
                          <td>
                              <a href="{{ route('slider.edit',$slider->id) }}" class="btn btn-info btn-big"><i class="material-icons">add_shopping_cart</i></a>
                      	</tr>
                        @endforeach
                      </tbody>
                    </table>
