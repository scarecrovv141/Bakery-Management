				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item"><a class="nav-link" href="/fast-food">Fast Foods</a></li>
							<li class="nav-item active"><a class="nav-link" href="/cakes">Cake</a></li>
							<li class="nav-item"><a class="nav-link" href="/chocolates&sweets">Chocolates & Sweets</a></li>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $key+1 }}</td>
                                            ...
                                            <td>{{ $cake->Price }}</td>
                                            <td>{{ $cake->Quantity }}</td>
                                            <td><img class="img-responsive img-thumbnail" src="{{asset('uploads/cake/'. $cake->image)}}" style="height:100px; width:100px"></td></td>
                                            <td><a href="{{ route('cake.edit', $cake->id) }}" class="btn btn-info btn-big"><i class="material-icons">add_shopping_cart</i></a>
                                            </td>
                                        </tr>
                                            @endforeach
                                    </tbody>
